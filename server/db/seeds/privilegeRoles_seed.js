        ...
        .insert([
          {
            id: 0,
            type: "admin",
            description: "ability to see admin pages and features",
          },
          { id: 1, type: "upload", description: "ability to upload a song" },
          {
            id: 2,
            type: "invite",
            description: "ability to invite other users to join",
          },
        ])
        .onConflict("type")
        .ignore();
